...
public class WeatherWidget extends javax.swing.JDialog {
           
           
     int width = (Toolkit.getDefaultToolkit().getScreenSize().width) - 580;
  DisplayTrayIcon dwt = new DisplayTrayIcon();
    ...
    public WeatherWidget(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        networkChecking();
        this.setLocation(width,460);
  ...
  condition.setText(disp.getCondition());
   ...
   sunset.setText(sunset.getText()+"  "+disp.getSunset());
    ...
    private void initComponents() {
        ...
        getContentPane().add(sunset, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 110, -1));

        sunrise.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        sunrise.setForeground(new java.awt.Color(255, 255, 255));
        sunrise.setText("Sunrise: ");
        getContentPane().add(sunrise, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 110, -1));

        condition.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        condition.setForeground(new java.awt.Color(255, 255, 255));
        condition.setText("Smoke");
        getContentPane().add(condition, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, 110, 30));

        line.setBackground(new java.awt.Color(255, 255, 255));
        line.setText(" ");
        line.setOpaque(true);
        getContentPane().add(line, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 30, -1, 60));

        cel.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        getContentPane().add(cel, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 60, 40));

        degree.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        degree.setForeground(new java.awt.Color(255, 255, 255));
        degree.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        degree.setText("º");
        degree.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                degreeMouseClicked(evt);
            }
        });
        getContentPane().add(degree, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 60, 40));

        temp.setFont(new java.awt.Font("Arial", 1, 42)); // NOI18N
        temp.setForeground(new java.awt.Color(255, 255, 255));
        temp.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        temp.setText("96");
        temp.setCursor(new java.awt.Cursor(java.awt.Cursor.MOVE_CURSOR));
        temp.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tempMouseClicked(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tempMousePressed(evt);
            }
        });
        temp.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                tempMouseDragged(evt);
            }
        });
        getContentPane().add(temp, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 5, 60, 110));
    ...
    private void celMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_celMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_celMouseClicked
    ...
    private void degreeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_degreeMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_degreeMouseClicked

    private void tempMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tempMousePressed
       xMouse = evt.getX();
       yMouse = evt.getY();
    }//GEN-LAST:event_tempMousePressed

    private void tempMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tempMouseDragged
             int x = evt.getXOnScreen();
             int y = evt.getYOnScreen();
             
             this.setLocation(x - xMouse, y - yMouse);
    }//GEN-LAST:event_tempMouseDragged
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WeatherWidget dialog = new WeatherWidget(new javax.swing.JFrame(), true);
