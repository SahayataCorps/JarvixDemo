 ...
 * @author Guest
 */
public class LoadingLink extends javax.swing.JDialog {
           String gif,gif1;
    ...
    int yMouse;
    Link GIF = new Link();
    public LoadingLink(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocation(width,320);
    ...
    private void initComponents() {
        ...
        getContentPane().add(link, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 130, 253, 65));
        ...
        heading.setText("LOAD SAVED LINKS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoadingLink.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoadingLink dialog = new LoadingLink(new javax.swing.JFrame(), true);
